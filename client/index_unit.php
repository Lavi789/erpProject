                        ...
                        <div class="modal-content">
                            ...
                            <form id="frm_user" name="frm_user" action="" method="post">
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <input id="unit_id" name="unit_id" type="hidden" class="form-control" placeholder="unit Id" readonly>

                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="unit_name" class="form-label"> Unit  Name</label>
                                        <input id="unit_name" name="unit_name" type="text" class="form-control" placeholder="unit Name">
                                    </div>
                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="unit_sname" class="form-label"> Unit  Sname</label>
                                        <input id="unit_sname" name="unit_sname" type="text" class="form-control" placeholder="unit Sname">
                                    </div>

                        ...
                        <div class="modal-content">
                            ...
                            <form id="frm_user" name="frm_user" action="" method="post">
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <input id="vehiclegroup_id" name="vehiclegroup_id" type="hidden" class="form-control" placeholder="vehicle group Id" readonly>

                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="vehiclegroup_name" class="form-label"> vehicle Name</label>
                                        <input id="vehiclegroup_name" name="vehiclegroup_name" type="text" class="form-control" placeholder="vehicle name">
                                    </div>
...
<script>
    var dtable = $('#table').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "../server/ajax_vehiclegrp.php",
            type: "POST"
        },
        "columns": [{
                "data": "vehiclegroup_id",
                "visible": false
            },
            {
                "data": "sl_no",
    ...
    function load_data(id) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#vehiclegroup_name").val(res.vehicle_name);

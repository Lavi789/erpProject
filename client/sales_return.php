    ...
    <div class="content content--top-nav">
        ...
        <div class="p-5 box mb-8 w-full sm:w-2/5">
            <div class="flex items-center">
                <label for="old_bill_no" class="form-label text-base mr-2"> Old Bill No.: </label>
                <input type="text" id="old_bill_no" name="old_bill_no" class="form-control" placeholder="Old Bill No.">
            </div>
    ...
    $("#barcode").on("change", function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (gstPer) {
                    if (res.gst_flag == 'Inclusive') {
                        let originalAmt = parseFloat(res.sales_rate) / (1 + (gstPer / 100));
                        gstAmt = parseFloat(res.sales_rate) - originalAmt;

                    } else if (res.gst_flag == 'Exclusive') {
                        gstAmt = parseFloat(res.sales_rate) * (gstPer / 100);
                    }
                }
                ...
                row += `<td class="inp_net_amt" id="inp_net_amt${count}">${res.sales_rate - discAmt}</td>`;
                ...
                totalNetAmt += parseFloat(res.sales_rate) - discAmt;

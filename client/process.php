                        ...
                        <div class="modal-content">
                            ...
                            <form id="frm_user" name="frm_user" action="" method="post">
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <input id="process_id" name="process_id" type="hidden" class="form-control" placeholder="Process Id" readonly>

                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="p_name" class="form-label">Name</label>
                                        <input id="p_name" name="p_name" type="text" class="form-control" placeholder=" Name">
                                    </div>
                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="short_name" class="form-label">Short Name</label>
                                        <input id="short_name" name="short_name" type="text" class="form-control" placeholder="short name">
                                    </div>
                                </div>
                            </form>
                            <!-- END: Modal Body -->

...
$bank = $conn->query("SELECT bank_id, bank_name FROM bank")->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body class="py-5 md:py-0">
    ...
    <div class="content content--top-nav">
        ...
        <!-- BEGIN: Add Button -->
        <button class="btn btn-primary shadow-md mr-2" onclick="add_data()" data-tw-toggle="modal" data-tw-target="#header-footer-modal-preview-view">Add Branch</button>
        <!-- END: Add Button -->
                        ...
                        <div class="modal-content">
                            ...
                            <form id="frm_user" name="frm_user" action="" method="post">
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <input id="branch_id" name="branch_id" type="hidden" class="form-control" placeholder="Branch Id" readonly>
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <select id="bank_id" name="bank_id" data-placeholder="Select Bank" class="form-select">

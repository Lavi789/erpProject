...
<body class="py-5 md:py-0">
    ...
    <div class="content content--top-nav">
        ...
        <!-- BEGIN: Add Button -->
        <button class="btn btn-primary shadow-md mr-2" onclick="add_data()" data-tw-toggle="modal" data-tw-target="#header-footer-modal-preview-view">Add Store Location</button>
        <!-- END: Add Button -->
                        ...
                        <div class="modal-content">
                            ...
                            <form id="frm_user" name="frm_user" action="" method="post">
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <input id="store_location_id" name="store_location_id" type="hidden" class="form-control" placeholder="Store Location Id" readonly>

                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="store_location_code" class="form-label">Store Location Code</label>
                                        <input id="store_location_code" name="store_location_code" type="text" class="form-control" placeholder="Store Location Code">
                                    </div>
                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="store_location_name" class="form-label">Store Location Name</label>
                                        <input id="store_location_name" name="store_location_name" type="text" class="form-control" placeholder="Store Location Name">
                                    </div>
...
<script>
    var dtable = $('#table').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "../server/ajax_storelocation.php",
            type: "POST"
        },
        "columns": [{
                "data": "store_lcoation_id",
                "visible": false
            },
            {
                "data": "sl_no",

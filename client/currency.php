                        ...
                        <div class="modal-content">
                            ...
                            <form id="frm_user" name="frm_user" action="" method="post">
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <input id="currency_id" name="currency_id" type="hidden" class="form-control" placeholder="currency  Id" readonly>

                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="country_name" class="form-label">Country Name</label>
                                        <input id="country_name" name="country_name" type="text" class="form-control" placeholder="Country  Name">
                                    </div>
                                    <div class="col-span-12 sm:col-span-6">

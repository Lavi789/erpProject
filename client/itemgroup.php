                        ...
                        <div class="modal-content">
                            ...
                            <form id="frm_user" name="frm_user" action="" method="post">
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <input id="itemg_id" name="itemg_id" type="hidden" class="form-control" placeholder="Item group Id" readonly>

                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="itemg_name" class="form-label">Item group </label>
                                        <input id="itemg_name" name="itemg_name" type="text" class="form-control" placeholder="Item group">
                                    </div>

...
<head>
    <meta charset="utf-8">
    <link href="dist/images/ERP.png" rel="shortcut icon">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="frm_user" name="frm_user" action="" method="post">
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <input id="vehicle_id" name="vehicle_id" type="hidden" class="form-control"
                                        placeholder="vehicle  Id" readonly>

                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="vehiclegrp_id" class="form-label"> vehiclegrp ID</label>
                                        <input id="vehiclegrp_id" name="vehiclegrp_id" type="text" class="form-control"
                                            placeholder="vehiclegrp id">
                                    </div>
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <div class="col-span-12 sm:col-span-6  container">
                                            <label for="driver_name" class="form-label"> Driver Name</label>
                                            <input id="driver_name" name="driver_name" type="text"
                                                class="form-control" placeholder=" Driver Name">
                                        </div>
                                        <div class="col-span-12 sm:col-span-6 container">
                                            <label for="driver_add" class="form-label"> Driver Add</label>
                                            <input id="driver_add" name="driver_add" type="text" class="form-control"
                                                placeholder=" Driver Add">
                                        </div>
                                        <div class="col-span-12 sm:col-span-6 container">
                                            <label for="driver_phno" class="form-label">Driver Phno</label>
...
function load_data(id) {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            $("#driver_phno").val(res.driver_phno1);

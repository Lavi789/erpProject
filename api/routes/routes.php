...
// *
//     BEIGN: REST API for unit
// */
$app->group("$base/unit", function (Group $group) {
    $group->get("", function (Request $request, Response $response) {
        try {
            $conn = new DB;
            $conn = $conn->connect();
    ...
    $group->post("", function (Request $request, Response $response) {
        try {
            ...
            $sql = "INSERT INTO unit (unit_name,unit_sname) VALUES (:unit_name,:unit_sname)";
            $stmt = $conn->prepare($sql);
            $stmt->bindParam(':unit_name', $parameters['unit_name']);
            $stmt->bindParam(':unit_sname', $parameters['unit_sname']);
    ...
    $group->put("/{id}", function (Request $request, Response $response, array $args) {
        try {
            ...
            $sql = "UPDATE unit SET unit_name=:unit_name,unit_sname=:unit_sname WHERE unit_id=:unit_id";
            $stmt = $conn->prepare($sql);
            $stmt->bindParam(':unit_id', $parameters['unit_id']);
            $stmt->bindParam(':unit_name', $parameters['unit_name']);
            $stmt->bindParam(':unit_sname', $parameters['unit_sname']);
    ...
    $group->delete("/{id}", function (Request $request, Response $response, array $args) {
        try {
            ...
            $stmt = $conn->prepare($sql);
            $stmt->bindParam(':unit_id', $args['id']);
            $stmt->execute();
...
/*
    END: REST API for unit
*/

// *
//     BEIGN: REST API for hsn

// */
$app->group("$base/hsn", function (Group $group) {
    $group->get("", function (Request $request, Response $response) {
        try {
            $conn = new DB;
            $conn = $conn->connect();

            $sql = "SELECT * FROM hsn_sac
            ";
            $stmt = $conn->query($sql);
            $data = $stmt->fetchAll(PDO::FETCH_OBJ);
            $conn = null;
    ...
    $group->post("", function (Request $request, Response $response) {
        try {
            ...
            $sql = "INSERT INTO hsn_sac (hsn_code,hsn_description) VALUES (:hsn_code,:hsn_description)";
            $stmt = $conn->prepare($sql);
            $stmt->bindParam(':hsn_code', $parameters['hsn_code']);
            $stmt->bindParam(':hsn_description', $parameters['hsn_description']);
    ...
    $group->put("/{id}", function (Request $request, Response $response, array $args) {
        try {
            ...
            $sql = "UPDATE hsn_sac
             SET hsn_code=:hsn_code,hsn_description=:hsn_description WHERE hsn_id=:hsn_id";
            $stmt = $conn->prepare($sql);
            $stmt->bindParam(':hsn_id', $parameters['hsn_id']);
            $stmt->bindParam(':hsn_code', $parameters['hsn_code']);
            $stmt->bindParam(':hsn_description', $parameters['hsn_description']);
    ...
    $group->delete("/{id}", function (Request $request, Response $response, array $args) {
        try {
            ...
            $sql = "DELETE FROM hsn_sac
             WHERE hsn_id=:hsn_id";
            $stmt = $conn->prepare($sql);
            $stmt->bindParam(':hsn_id', $args['id']);
            $stmt->execute();
